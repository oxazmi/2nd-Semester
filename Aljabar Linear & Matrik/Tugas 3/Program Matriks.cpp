...
int main ()
{
    ...
    // Menambahkan Baris dan Kolom Matriks A dan B
    ...
    else
    {
        ...
        cout << endl;
        cout << " Hasil Perkalian Matriks A x B = " << endl << endl;
        for (i=0; i<m; i++)
        {
            for (j=0; j<q; j++)
            {
    ...
    {
        cout << " Hasil dari Pengurangan Matriks = " << endl << endl;
        for (int i=0; i<m; i++)
        {
            for (int j=0; j<n; j++)
            {
    ...
    {
        cout << " Hasil dari Penjumlahan Matriks = " << endl << endl;
        for (int i=0; i<m; i++)
        {
            for (int j=0; j<n; j++)
            {
