/* Buatlah Program yang menampilkan hasil seleksi tinggi badan dari para pelamar kerja PT KAI
   Syarat Lolos adalah
   # Pelamar laki laki memiliki tinggi badan minimal 170 cm
   # Pelamar perempuan memiliki tinggi badan minimal 160 cm */
